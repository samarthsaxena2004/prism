...
const LEFT_LABELS = ["Sage", "Oracle", "Sentinel"]
const RIGHT_LABELS = ["Compass", "Echo", "Archive"]
  ...
  return (
    <div className="relative w-full max-w-[800px] mx-auto">
      <svg
        ...
        role="img"
        aria-label="PRISM document intelligence pipeline showing five-agent architecture: Sage vision processing, Oracle validation, Sentinel anomaly detection, Compass structuring, Echo intelligence synthesis"
      >
